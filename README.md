...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x4va-iu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x4va-iu.containers.anotherwebservice.com/
...
```
git clone git@github.com:sircloudstar/container-x4va-iu.git
cd container-x4va-iu
```
...
```
docker attach container-x4va-iu
```
